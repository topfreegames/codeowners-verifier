...
//go:generate mockgen -destination=pkg/providers/gitlab_client_mock.go -package=providers github.com/topfreegames/codeowners-verifier/pkg/providers ClientInterface
